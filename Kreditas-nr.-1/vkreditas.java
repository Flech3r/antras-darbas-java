		...
		if(is<15000)
			if (k>=300&&k<=260000)
				if(l<=5){		
					...
					if(((Vimk/a)*100)<=40)
						System.out.println("Kreditą suteikti galima!" + " " + "Viso gražinti reikės: " + Ksum + " " + "Menėsine įmoka bus: " + Vimk);
					else 
						System.out.println("Kredito suteikti negalime! ");
					}else 
						System.out.println("Kredito suteikti negalime! Perilgas terminas!");
					else 
						System.out.println("Kredito suteikti negalime! Prašoma suma yra permaža arba per didelė!");
					else 
						System.out.println("Kredito suteikti negalime! Jusu įsiskolinimai per dideli");	
	}
